...
RULES_TEXT = """
Правила игры:
В игре три раунда, в каждом из которых игроку и боту-хакеру выдается по 10 карт таким образом, чтобы игрок точно смог отразить атаку.
